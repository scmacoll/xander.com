            ...
            <div className={`${styles.similarContainer} border-y border-solid border-foreground`}>
              <div className={`${styles.similarBooks} `}>
                ...
                {books.map((book, index) => (
                  <div key={index} className={`${styles.bookBlock} min-w-20`}>
                    <div className="flex justify-center w-44 h-44 mx-auto">
                      <div className="flex-grow bg-white"></div> {/* Left white fill */}
                      <img
                          className={`${styles.responsiveImage}`}
                          ...
                          // height="115"
                        />
                      <div className="flex-grow bg-white"></div> {/* Right white fill */}
                    </div>
                    <div className="w-40 flex flex-col mx-auto">
                      <div className={` ${styles.textFlowFour} pt-3 text-xs font-extrabold h-fit max-h-20 `}>{book.book_title}</div>
                      <div className={` ${styles.textFlowTwo} max-h-8 text-xs text-gray-400`}>{book.book_authors}</div>
                      <div className="font-black py-2 text-xs flex items-center justify-center">${book.book_price}</div>
