...
const CheckoutPageContent: React.FC = () => {
  return (
      <div className="mx-auto flex w-full flex-col border border-solid border-red overflow-hidden">

        <div className="flex flex-col">

          <div id="checkoutTitle"
               className="mx-auto flex flex-row pt-1 pb-3 w-532px xs:flex-row sm:flex-row md:hidden lg:hidden">
          ...
          <div className="flex">
            <div className="w-screen border-y border-solid border-foreground">
              <div className="mx-auto my-0 flex justify-between py-2 w-532px">
        ...
        <div className="mx-auto flex flex-col xs:px-4 sm:px-8 md:px-8 lg:px-0">
          <div
              id="pageContainer"
