        ...
        >
                        ...
                        <div id="orderButton" className="flex">
                          ...
                          >
                            <Link id="reviewOrderButton"
                                  ...
                                  className={`xxs:text-xs border-2 rounded font-bold py-3 px-4 border-solid
          ...
          <div id="rightContentWrapper"
            ...
            <div id="checkoutTitle"
              ...
              <div id="orderSummaryBanner"
                ...
                <div id="clearCartWindow"
                    ...
                    xs:translate-y-20 sm:translate-y-20 xxs:translate-x-0 xs:translate-x-11 px-4 py-3 h-20 border-solid
            ...
            <aside id="borderSummary"
              ...
              <div
                className={`${styles.scrollBar} ${styles.scrollBarContent} max-h-610px overflow-y-auto overflow-x-hidden`}>
